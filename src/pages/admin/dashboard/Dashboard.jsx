        ...
        <Layout>
            <div className="py-10">
                <div
                    ...
                    <div className="right">
                        <h1
                            className='text-justify font-bold text-2xl mb-2'
                        ...
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">fachrirozyafif@gmail.com
                        </h2>
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">
                            <span>Total Blog : </span>  03
                        </h2>
                                ...
                                <tbody>
                                    <tr className=" border-b-2" style={{ background: mode === 'dark' ? 'rgb(30, 41, 59)' : 'white' }}>
                                        ...
                                        <th style={{ color: mode === 'dark' ? 'white' : 'black' }} scope="row" className="px-6 py-4 font-medium ">
                                            {/* thumbnail  */}
                                            <img className='w-16 rounded-lg' src={'/src/assets/gambar/235951.png'} alt="thumbnail" />
                                        </th>
