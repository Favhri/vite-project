        ...
        <div className="container px-5 py-10 mx-auto max-w-7xl ">
          ...
          <div className="flex flex-wrap justify-center -m-4 mb-5">
            ...
            <div className="p-4 md:w-1/3" >
              ...
              >
                {/* Blog Thumbnail  */}
                <img className=" w-full" src={'/gambar/235951.png'} alt="blog" />
            ...
            <div className="p-4 md:w-1/3" >
              ...
              >
                {/* Blog Thumbnail  */}
                <img className=" w-full" src={'/gambar/2022610012.jpeg'} alt="blog" />
            ...
            <div className="p-4 md:w-1/3" >
              ...
              >
                {/* Blog Thumbnail  */}
                <img className=" w-full" src={'/gambar/pkn3.png'} alt="blog" />
